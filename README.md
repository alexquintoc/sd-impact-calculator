...
## Tech Stack (Current / Experimental)

- Next.js
- Tailwind CSS
- MDbook
- TinaCMS
- JSON-driven documentation generation
...
- Shared project sustainability repositories
- Public-facing sustainability project profiles
- API access to SD Standard criteria
- Design-sector benchmarking tools
- Certification or recognition pathways
- Community-contributed case studies
- Expanded sustainability metrics and scoring systems
